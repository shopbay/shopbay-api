<?php
/**
 * NOTE: A bug fix is added to this class for PHP 7.2 compatibility since mcrypt() function is removed PHP 7.2! use random_bytes() instead
 * -> Search for code line "BEGIN BUGFIX"
 * @author kwlok 
 */
...
class AccessToken implements AccessTokenInterface
{
    ...
    protected function generateAccessToken()
    {
        if (function_exists('mcrypt_create_iv')) {
            //-- BEGIN BUGFIX
            //BUG FIX: To support PHP 7.2 compatibility - mcrypt function is removed! use random_bytes() instead
            $randomData = random_bytes(MCRYPT_DEV_URANDOM);
            //-- END BUGFIX
